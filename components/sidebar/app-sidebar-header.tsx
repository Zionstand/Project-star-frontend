...
export const AppSidebarHeader = () => {
  return (
    <header className="sticky z-50 top-0 bg-background border-b flex h-20 shrink-0 items-center gap-2 transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-20">
